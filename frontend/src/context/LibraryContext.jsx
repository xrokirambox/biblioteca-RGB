...
export function LibraryProvider({ children }) {
  ...
  const openModal = () => { setLevel(0); setNivelId(null); setGradoId(null); setHierCatId(null); setHierSubId(null); setModalOpen(true); };
  ...
  const goToHierCat = (id) => { setHierCatId(id); setLevel(1); };
