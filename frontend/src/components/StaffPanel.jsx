...
export const StaffPanel = ({ open, onClose }) => {
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[55] bg-[#020b04]/90 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 animate-fade-in"
      onClick={onClose}
    ...
    >
      ...
      >
        {/* Header */}
       <div className="px-3 sm:px-6 py-3 border-b border-[#c9a227]/20 bg-[#020b04]/60 flex items-center gap-3 sm:gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="font-cinzel text-base sm:text-xl text-[#f4f1e1] truncate">Panel del Personal</div>
            <div className="font-dm-sans text-[9px] sm:text-[10px] tracking-[0.15em] sm:tracking-[0.25em] uppercase text-[#c9a227] truncate">
          ...
          {TABS.map((t) => {
            ...
            return (
              <button
                ...
                className={`relative shrink-0 px-3 sm:px-4 py-2 inline-flex items-center gap-1.5 sm:gap-2 font-dm-sans text-[10px] sm:text-xs tracking-widest uppercase transition-colors ${
