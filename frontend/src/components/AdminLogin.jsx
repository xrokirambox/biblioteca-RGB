...
export const AdminLogin = () => {
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[60] bg-[#020b04]/90 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in"
      onClick={() => setLoginOpen(false)}
      data-testid="admin-login-overlay"
    >
      <div
        className="w-full max-w-md bg-[#051a09] border border-[#c9a227]/30 rounded-xl shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden animate-scale-in"
      ...
      >
        <div className="p-6 border-b border-[#c9a227]/20 bg-[#020b04]/60 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-cinzel text-[#f4f1e1] text-lg">Acceso Admin</div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div>
            <label className="block font-dm-sans text-xs tracking-widest uppercase text-[#c9a227]/80 mb-2">
              Correo
            </label>
            <input
              type="email"
